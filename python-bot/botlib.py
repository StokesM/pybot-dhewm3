...
class bot:
    ...
    #                  It return the amout of ammo left.
    #
    ...
    # Matthew Stokes
    #
    # start_firing - begin firing your weapon
    #                returns ammo left.
    ...
    # Matthew Stokes
    #
    # stop_firing - stop firing your weapon
    #                returns ammo left.
    ...
    # Matthew Stokes
    # Change weapon - chances weapon to weapon_no
    #               - If weapon no is not in inventory
